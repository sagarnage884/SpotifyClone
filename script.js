...
function playSong(name) {
    ...
    document.querySelector("#play").src = "SpotifyClone/Mysvgs/pauseButton.svg";
    ...
    icon.addEventListener("click", (e) => {
        if (currentSong.volume == 0) {
            icon.src = "SpotifyClone/Mysvgs/volume.svg";
            currentSong.volume = 0.3;
            vol.value = 30;

        }
        else {
            icon.src = "SpotifyClone/Mysvgs/mute.svg";
...
async function main(folderN) {
    ...
    document.querySelector("#play").onclick = () => {
        if (currentSong.paused) {
            currentSong.play();
            document.querySelector("#play").src = "SpotifyClone/Mysvgs/pauseButton.svg?v=" + Date.now();
        } else {
            currentSong.pause();
            document.querySelector("#play").src = "SpotifyClone/Mysvgs/playButton.svg?v=" + Date.now();
        }
    };
